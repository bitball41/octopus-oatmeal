...
def patch_index() -> None:
    ...
    # loads multiplayer_upstream.js, game.js, love.js, and WASM from that one
    # immutable jsDelivr commit. game.data is loaded from GitHub raw so
    # Paperback can exceed jsDelivr's 20 MB file cap. Never rewrite the
    # launcher back to mutable @main URLs.
