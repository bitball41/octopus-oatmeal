...
(function () {
  var loadPackage = function (metadata) {
    ...
    var REMOTE_PACKAGE_BASE = "game.data?v=dfc9a8f5745d";
    if (
  ...
  loadPackage({
    package_uuid: "dfc9a8f5745d50a4f5086384748d2fbeaf365b6dddb803e3aa2d035d986402a2",
    remote_package_size: 10651878,
    files: [
      {
        filename: "/game.love",
        crunched: 0,
